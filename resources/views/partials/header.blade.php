<div class="nav">
    <ul class="userNav">
        <li>
            <a id="notificationsDropdown" href="#" role="button" aria-expanded="false" data-bs-toggle="dropdown">
            ...
            <ul id="notification-list" class="dropdown-menu" aria-labelledby="notificationsDropdown">
                @include('partials.notification-list', compact($notifications))
            </ul>
        </li>
        <li class="userLi dropdown">
            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" aria-expanded="false" data-bs-toggle="dropdown">
